                ...
                <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
                    ...
                    {loggedin &&
                        <Popover.Group as="nav" className="hidden md:flex space-x-10">
                            <div onClick={() =>history.push("/dashboard/request")} className="cursor-pointer text-xl font-medium text-gray-500 hover:text-gray-900">
                                Requests
                            </div>
                    ...
                    {loggedin ?
                        <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
                            <a
                                href="/" onClick={() => {localStorage.removeItem('amexloggedin'); localStorage.removeItem('email'); localStorage.removeItem('bank'); setloggedin(false);}}
                        ...
                        <div className="py-6 px-5 space-y-6">
                            {loggedin &&
                                <div className="grid grid-cols-2 gap-y-4 gap-x-8">
                                    <div onClick={() =>history.push("/dashboard/request")} className="cursor-pointer text-base font-medium text-gray-900 hover:text-gray-700">
                                        Requests
                                    </div>
                            ...
                            {loggedin ?
                                <a
                                    href="/"
                                    onClick={() => {localStorage.removeItem('amexloggedin'); localStorage.removeItem('email'); localStorage.removeItem('bank'); setloggedin(false);}}
