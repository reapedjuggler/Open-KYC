...
public class Controller {
    ...
    public ResponseEntity<String> issueIOU(HttpServletRequest request) throws IllegalArgumentException {
        ...
        try {
            ...
            SignedTransaction result = proxy.startTrackedFlowDynamic(ExampleFlow.Initiator.class, amount,otherParty,aadhar,pan,email,approval,timestamp).getReturnValue().get();
            // Return the response.
